package awagadro.studentApp.jTest;
...
import awagadro.studentApp.facade.ApplicantFacade;
import awagadro.studentApp.facade.ProfessionFacade;
import awagadro.studentApp.facade.SubjectFacade;
import awagadro.studentApp.view.ApplicantResultView;
import awagadro.studentApp.view.ApplicantView;
import awagadro.studentApp.view.ProfessionView;
import awagadro.studentApp.view.SubjectView;

@ContextConfiguration(locations = { "context.xml", "database.xml" })
public class StudentFacadeTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void professionTest() {
		...
		for (SubjectView sv : svList) {
			if (sv.getSubjectName().equals("Mathematics") || sv.getSubjectName().equals("Physics")
					|| sv.getSubjectName().equals("Literature")) {
				check.add(sv.getSubjectId());
			}
		}
		professionFacade.updateSubjectList(idProf, check);
